...
#        set various event handlers
        ...
        self.X = cv2.blur(self.original,(self.kernel_size,self.kernel_size))    
        ...
        # create slider        
        # kernel size
        allowed_kernel_size = np.concatenate([np.linspace(0, 20, 21)])
        ...
        def update(val):
            ...
            self.X = cv2.blur(self.original,(ks,ks))        
