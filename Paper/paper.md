...
![Figure 1. Schematic of the required inputs to the simulator to generate image datasets.](Figures/Fig 1.jpg)
...
![Figure 2. Graphical interface for the simulator.](Figures/Fig 2.jpg)
...
![Figure 3. Examples of images produced from different acquisition sequences and k-space trajectories. TSE (turbo spin echo), IR (inversion recovery), SSFP (steady state free precession).](Figures/Fig 3.jpg)
...
![Figure 4. Global architecture and operations of the simulator and generator.](Figures/Fig 4.jpg)
